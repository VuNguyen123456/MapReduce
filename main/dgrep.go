...
func mapF(filename string, input_arg string, contents string) (res []mapreduce.KeyValue) {
	...
	// Remove existing output file at start of map phase to ensure clean output
	// This is safe even if called multiple times since os.Remove is idempotent
	os.Remove("mrtmp.dgrep")
